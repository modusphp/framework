...
$di->setter['Aura\View\TwoStep']['setOuterView'] = $config['template']['layout'];
$di->setter['Aura\View\TwoStep']['setInnerPaths'] = $config['template']['view_paths'];
...
/**
 * Modus\Template\Helper\Messages
 */
...
/**
 * Modus\Template\Helper\Paginator
 */
